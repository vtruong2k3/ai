    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="absolute -right-3 top-4 z-50 rounded-full border border-slate-200 bg-white p-1 shadow-sm hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700"
            >
                {isCollapsed ? (
